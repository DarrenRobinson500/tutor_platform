# Generated by Django 4.2.27 on 2026-02-22 05:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('grades', models.CharField(blank=True, max_length=50, null=True)),
                ('order_index', models.IntegerField(default=0)),
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='children', to='backend.skill')),
            ],
        ),
        migrations.CreateModel(
            name='Task',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('skill', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='backend.skill')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='student_weekly', to=settings.AUTH_USER_MODEL)),
                ('tutor', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='appointment_tutor_weekly', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='TutorProfile',
            fields=[
                ...
                ('color_scheme', models.CharField(blank=True, max_length=20, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('template', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='backend.template')),
            ],
        ),
        migrations.CreateModel(
            name='TaskItem',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('template', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='backend.template')),
            ],
        ),
        migrations.AddField(
            model_name='question',
            name='template',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='backend.template'),
        ),
        migrations.CreateModel(
            name='Notification',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tutor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='appointment_tutor', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='TutorStudent',
